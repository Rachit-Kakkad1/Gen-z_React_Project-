                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center max-w-6xl mx-auto">
                        {supportCategories.map((category) => (
                            ...
                            >
                                ...
                                {category.link ? (
                                    <Link to={category.link} className="text-amber-500 font-semibold tracking-wide uppercase inline-flex items-center justify-center gap-2 group-hover:text-amber-600 transition-colors">
                                        {category.actionText}
