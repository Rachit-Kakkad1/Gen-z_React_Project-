        ...
        <div className="w-full fixed top-0 z-78 border-2 backdrop-blur-2xl">
            ...
            <div className="flex items-center justify-between px-6 py-8  sm:px-12 md:px-24 lg:40 ">
                ...
                <div className="hidden sm:flex items-center justify-between space-x-6 font-semibold">
                    ...
                    <Link to="/" className="cursor-pointer hover:text-amber-400 transition-colors">Home</Link>
                    <Link to="/about" className="cursor-pointer hover:text-amber-400 transition-colors">About</Link>
                    <Link to="/carrer" className="cursor-pointer hover:text-amber-400 transition-colors">Career</Link>
                    <Link to="/support" className="cursor-pointer hover:text-amber-400 transition-colors">Support</Link>
                </div>

                {/* Button */}
                <div className="hidden sm:block">
                    <Link to="/contact">
                        <button className="cursor-pointer flex items-center gap-2 px-4 py-4 bg-amber-500 rounded-full hover:scale-105 transition-transform duration-300">
                            Contact us
                            <FaArrowRightLong />
                        </button>
                    </Link>
                ...
                {
                    menuBar ? <FaXmark onClick={() => { setMenu(!menuBar) }} className="cursor-pointer font-semibold text-3xl z-10 sm:hidden" /> :
                        <FaBars onClick={() => { setMenu(!menuBar) }} className="cursor-pointer text-3xl font-semibold sm:hidden" />
                }
                ...
                {/* mobile nav bar */}
                {
                    ...
                    <Link onClick={() => { setMenu(!menuBar) }} to="/" className="cursor-pointer hover:text-purple-500 transition-colors">Home</Link>
                    <Link onClick={() => { setMenu(!menuBar) }} to="/about" className="cursor-pointer hover:text-purple-500 transition-colors">About</Link>
                    <Link onClick={() => { setMenu(!menuBar) }} to="/carrer" className="cursor-pointer hover:text-purple-500 transition-colors">Career</Link>
                    <Link onClick={() => { setMenu(!menuBar) }} to="/support" className="cursor-pointer hover:text-purple-500 transition-colors">Support</Link>

                        <div>
                            <Link onClick={() => { setMenu(!menuBar) }} to="/contact">
                                <button className="cursor-pointer flex items-center gap-2 px-2.5 py-2.5 bg-amber-500 rounded-full hover:scale-105 transition-transform">
                                    Contact us
                                    <FaArrowRightLong />
                                </button>
                            </Link>
